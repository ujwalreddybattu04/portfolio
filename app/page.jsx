          ...
          <div className="flex flex-col gap-4 w-auto max-w-[380px] text-center xl:text-left">
            ...
            >
              <h1 className="h1">
                Hello,
                <br />
                I'm <span className="text-accent">Battu Ujwal Reddy!</span>
              </h1>
            </motion.div>
            {/* bio */}
            <motion.div
            ...
            >
              <p>
               B.Tech student at IIIT Vadodara, actively exploring the world of Artificial Intelligence, Frontend Development, and Machine Learning.
              </p>
            </motion.div>
            {/* take action */}
            <motion.h3
            ...
            <div className="flex flex-col xl:flex-row items-center justify-center xl:items-center xl:justify-start gap-6 pt-2">
              <motion.a
                ...
                // href="/assets/"
                download
                aria-label="Download Ujwal's CV"
              >
                <Button
                  variant="outline"
                  size="md"
